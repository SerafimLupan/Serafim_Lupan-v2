...
For my first participation, it's a start, I gained experience from this, I learned from my mistakes and it's a reason to motivate me to prepare intensively not only for the upcoming competitions but also for those from last year.
  ...
  },
  {
    ...
    summary: "Where did I sign up and when will they be?",
    content: `
Well, I signed up for many CTF competitions. Chronologically speaking, I signed up for **\"ROCSC 2026\"** (**RO Cyber ​​Security Competition**) in juniors, but to qualify you have to be in the top 25 where I out of 478 total participants and 249 with a positive score came out in 142nd place, for the first time it's a pretty remarkable achievement. Then **\"UNbreakable Romania Teams - Edition 2026\"**, it will start on *Friday, March 6, 2026 at 11:00 AM* and will end on *Sunday, March 8, 2026 at 11:00 AM*, I will participate with my team **\"Tsha_lava\"**, where I am not the leader, but at least I am part of the team and I will give everything for the team. There are 3 in the team: me, Team leader Dragoș and Bogdan. Then I signed up for **\"UNbreakable Romania Bootcamp - 2026 Edition\"**, where obviously it's a bootcamp that prepares us for **\"UNbreakable Romania Individual - 2026 Edition\"**. I also signed up for **\"OSC 2026 - county phase\"** (**Cyber ​​Security Olympics 2026**, county phase) which will start *Friday, April 24, 2026 at 10:00 AM* for me because I study in **Fălticeni**, the evaluation center is in **Suceava**, it turns out that I will participate against those from **Suceava county**. If I come in first place, I will enter the national phase *May 16-19*, *2026*, **Bucharest**.    
    `
  },
  {
    id: "8",
